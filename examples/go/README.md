...
+build | Target github.com/drone-runners/drone-runner-docker/examples/go:docs-vlad-examples+build built successfully
=========================== SUCCESS ===========================
+build | Artifact github.com/drone-runners/drone-runner-docker/examples/go:docs-vlad-examples+build/go-example as local build/go-example
```
...
+docker | Target github.com/drone-runners/drone-runner-docker/examples/go:docs-vlad-examples+docker built successfully
=========================== SUCCESS ===========================
...
+docker | Image github.com/drone-runners/drone-runner-docker/examples/go:docs-vlad-examples+docker as go-example:latest
+build | Artifact github.com/drone-runners/drone-runner-docker/examples/go:docs-vlad-examples+build/go-example as local build/go-example
```
